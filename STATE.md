...
## 3. 경계
- **사전 승인됨(2026-08-23, 에픽 이슈에 정본)**: 2단계 DB 행 변경 · 002+ DDL 운영 적용(추가만, DROP·타입변경·데이터손실 제외) · 컷오버 조건부(#10) · LLM(`CLAUDE_API_KEY`, 하드스톱 $7, 리뷰·댓글 원문 전송 OK) · push·이슈·gh · 1차/2차 패스 기준(계약) · STATE.md 체계.
