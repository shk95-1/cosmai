...
def test_the_ddl_declares_the_twentyeight_contract_tables():
    ...
    # + 2 from 022_panel_and_quarter.sql (fork issue #3: panel_channel, metrics_topic_quarter).
    # The embeddings live in files for now, so there is no table for them yet.
    assert len(declared_tables()) == 28
