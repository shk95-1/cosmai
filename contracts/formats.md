...
- **Measured against the slice-p9 rows, 2026-09-13** (`tool/measure-wish-axis-lexicon`, read-only): format **P 0.956 · R 0.843** (tp 6,236 · fp 287 · fn 1,158), attribute **P 0.926 · R 0.891** (tp 3,331 · fp 267 · fn 409); 5,360 and 3,154 rows filled against slice-p9's 5,905 and 3,253. Per canonical, precision ≥ 0.95 on 31 of 36 format and 16 of 23 attribute; the six that are not are named in the completion report on #124, and each one's disagreements are sentences slice-p9 lost to its own three-value cap, not values the seed invents.
