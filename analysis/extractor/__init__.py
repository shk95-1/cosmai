"""규칙 추출기 rule-v2.2 — 후보 문장(slice-suncare·slice-p1)과 바람 분류 a/b/c/n(slice-p9).
...
LAUNCH = re.compile(
    ...
    r"|재출시|다시 출시|정식 출시|국내 출시|한국 출시|한국에도|국내에도|한국에서도|올영에도|올리브영에도"
    r"|오프라인에도"
    r"|나왔으면|나오면 좋|나오면 (바로 |꼭 )?(사야|살|삽니다|살게|사고 ?싶|사려|사겠|살거|사겠|대박)"
    r"|나왔음 좋"
    r"|나왔음 하|나와 ?줬으면|나와 ?주세요|(다시|도|또) ?나와야|나오길|나오기를"
    ...
    r"|팔아 ?주|팔면 좋|입점 ?(해|했으면|됐으면|되면|좀|부탁)"
    ...
    r"(?=.{0,25}(나오면|나왔으면|나오길|있으면 좋|있었으면|출시(해|됐으면|되었으면|되면|좀)|만들어 ?주"
    r"|만들면"
